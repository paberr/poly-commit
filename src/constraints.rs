...
>: Clone
{
    ...
    type VerifierKeyVar: AllocVar<PC::VerifierKey, ConstraintF> + ToBytesGadget<ConstraintF> + Clone;
    ...
    type CommitmentVar: AllocVar<PC::Commitment, ConstraintF> + ToBytesGadget<ConstraintF> + Clone;
